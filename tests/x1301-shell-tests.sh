...
diff -u <(printf 'X1301 EVENT DISCONNECTED\nX1301 EVENT PRESENT_NO_SIGNAL\nX1301 EVENT LOCKED width=1920 height=1080 fps=59.94\nX1301 EVENT MODE_CHANGE old=1920x1080 new=1280x720\n') "$TMP/watch"
